...
function MenuCard({ item }: { item: MenuItem }) {
  return (
    <div className="bg-surface border border-border rounded-3xl p-4 flex items-center gap-5 hover:shadow-md hover:border-primary/30 transition-all duration-300">
      {/* Image */}
...
export default function MenuPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Category Tabs */}
      <div className="sticky top-16 z-40 bg-background/90 backdrop-blur-md border-b border-border px-6 py-4">
